  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        variant === "destructive" &&
          "border-red-500 bg-red-600 text-white dark:border-red-900 dark:bg-red-900 dark:text-gray-50",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-gray-200 bg-transparent px-3 text-sm font-medium ring-offset-white transition-colors hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-950 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-800 dark:ring-offset-gray-950 dark:hover:bg-gray-800 dark:focus:ring-gray-300 group-[.destructive]:border-gray-100/40 group-[.destructive]:hover:border-red-500/30 group-[.destructive]:hover:bg-red-500 group-[.destructive]:hover:text-gray-50 group-[.destructive]:focus:ring-red-500",
      className,
    )}
    {...props}
  />
...
export type { ToastProps as ToastPrimitiveProps, ToastProviderProps } from "@radix-ui/react-toast"
export {
